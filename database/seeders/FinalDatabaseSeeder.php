...
class FinalDatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            [
                'id' => 1, 'title' => 'Workshop Literasi Digital', 'slug' => 'workshop-literasi-digital', 
                'category' => 'workshop', 'banner' => 'https://images.unsplash.com/photo-1596496638641-e240fd67b4c3',
                'description' => 'Pelajari cara memanfaatkan perpustakaan digital.', 'event_date' => '2026-01-22',
                'event_time' => '14:00 - 16:00 WIB', 'location' => 'Ruang Seminar Lantai 3',
                'location_type' => 'physical', 'status' => 'published', 'status_event' => 'upcoming', 'user_id' => 1
            ],
            [
                'id' => 3, 'title' => 'Pameran Manuskrip Nusantara', 'slug' => 'pameran-manuskrip', 
                'category' => 'exhibition', 'banner' => 'https://images.unsplash.com/photo-1723721229325-b286656e768a',
                'description' => 'Koleksi manuskrip langka AR Immersive.', 'event_date' => '2026-01-28',
                'event_time' => '10:00 - 17:00 WIB', 'location' => 'Galeri Utama',
                'location_type' => 'physical', 'status' => 'published', 'status_event' => 'ongoing', 'user_id' => 1
            ],
            [
                'id' => 5, 'title' => 'Story Time Interaktif Anak', 'slug' => 'story-time-interaktif', 
                'category' => 'workshop', 'banner' => 'https://images.unsplash.com/photo-1763013259158-8a8370542ddb',
                'description' => 'Sesi mendongeng dengan animasi.', 'event_date' => '2026-02-05',
                'event_time' => '10:00 - 11:30 WIB', 'location' => 'Children Corner',
                'location_type' => 'physical', 'status' => 'published', 'status_event' => 'full', 'user_id' => 1
            ],
        ];
        ...
        $libInfos = [
            [
                'id' => 1, 'title' => 'Jam Operasional Perpustakaan', 'slug' => 'jam-operasional', 
                'banner' => 'https://images.unsplash.com/photo-1521587760476-6c12a4b040da', 
                'content' => "Senin - Jumat: 08:00 - 20:00 WIB\nSabtu: 09:00 - 15:00 WIB\nMinggu: Tutup", 
                'type' => 'service', 'status' => 'published', 'user_id' => 1
            ],
            [
                'id' => 2, 'title' => 'Kontak & Lokasi', 'slug' => 'kontak-lokasi', 
                ...
                'type' => 'contact', 'status' => 'published', 'user_id' => 1
            ],
        ];
